...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- In real-world webapps, css is usually minified and
      ...
      <p id= "para2"> here is your main play screen. you can move this line around with your mouse,<br> and click to toggle when you have it at the angle you want.</p>
      <p id= "para3"> this is where you type in <br> the word or phrase you want to swing with</p>
      ...
      <p id= "para6"> this box shows the terrain you are in. <br>rougher terrain (like the bunker) <br> makes your swings less powerful, <br>so keep that in mind!</p>
